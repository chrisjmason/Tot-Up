...
public class CustomFabToolbar extends FrameLayout {
    ...
    public CustomFabToolbar(Context context) {
        super(context);
        init();
    }

    public CustomFabToolbar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
        loadAttributes(context, attrs);
    }

    public CustomFabToolbar(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void loadAttributes(Context context, AttributeSet attrs) {
        ...
        try {
            ...
            mFabSize = a.getInteger(R.styleable.FabToolbar_tb_fab_type, DEFAULT_FAB_SIZE);
        } finally {
            a.recycle();
        }
